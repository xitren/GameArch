...
int main(int argc, char *argv[]) {
  ...
  // Grayscale image
  IplImage* grayscaleImg = cvCreateImage(cvSize(320,240), 8/*depth*/, 1/*channels*/);
  ...
  while(key != 27 /*escape key to quit*/ ) {
    ...
    //imposto manualmente la durate di ogni frame
    char c=cvWaitKey(33);
    //cerco di mostrare i fps
    ...
    //Elimino la finestra che mostra il video grezzo
